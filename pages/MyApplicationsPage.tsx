...
import { Briefcase, CalendarDays, ExternalLink, FileText, CheckCircle, XCircle, Clock, ListFilter } from 'lucide-react';
...
const MyApplicationsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!user || user.role !== 'contributor') {
      setIsLoading(false);
      // This page should be protected by a route guard, but defensive check here
